		...
		<form method="post" name="fm">
			<table>
				<tr>
					...
					<!-- name을 update의 경우와 같게 하여 if문으로 처리  -->
				</tr>
				...
				<tr>
					<td><b>내용</b></td>
					<td><textarea style="width: 700px; height: 250px;"
							name=content rows="600" cols="70" maxlength="100000" required></textarea></td>
				</tr>
			</table>
