...
import kr.ac.kopo.ctc.kopo15.dao.StockItemDaoImpl;
import kr.ac.kopo.ctc.kopo15.dto.Pagination;

public class StockItemServiceImpl implements StockItemService {

	private StockItemDao stockitemdao = new StockItemDaoImpl();
	...
	@Override
	   public Pagination getPagination(int page, int countPerPage) {
	      ...
	      StockItemDaoImpl stockitemimpl= new StockItemDaoImpl();
	      int totalCount = stockitemimpl.totalCount(); //총 데이터 개수
...
//			pagination.setNn(nn);		//맨 끝 페이지 이동 기호 
	...
	@Override
	public kr.ac.kopo.ctc.kopo15.dao.StockItemDao getStockItemDao() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void StockItemDao(kr.ac.kopo.ctc.kopo15.dao.StockItemDao stockitemdao) {
		// TODO Auto-generated method stub
	}	
